...
// IF u need to declare var outside func --> use var explicitly
var infolog = log.New(os.Stdout,"Info\t",log.Ldate | log.Ltime)
var errorlog = log.New(os.Stdout,"Info\t",log.Ldate | log.Ltime | log.Lshortfile)

// * Initiaitng instance of Message type struct
...
var payload services.JsonResponse //* setting var to type J.R
	payload.Error = true
